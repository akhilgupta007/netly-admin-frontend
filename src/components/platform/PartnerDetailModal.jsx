      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl border border-border-main shadow-xl overflow-hidden flex flex-col animate-scale-up">
        ...
        <div className="p-5 space-y-4 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-semibold ${partner.status === "Active" ? "text-emerald-500 bg-emerald-50" :
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-b border-border-main py-4 text-text-primary">
          ...
          <div className="bg-page-bg/40 rounded-2xl p-4 space-y-2.5 border border-border-main/50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:border-l sm:border-border-main sm:pl-4">
