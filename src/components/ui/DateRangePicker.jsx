  ...
  return (
    <div className="relative">
      <button
        ...
        className="border border-border-main md:text-xs text-[10px] rounded-full px-4 py-2.5 text-text-muted cursor-pointer flex items-center gap-1.5 bg-white hover:bg-page-bg transition select-none"
      >
        {startDate ? (
          endDate ? (
      ...
      {calendarOpen && (
        <>
          <div
            className="fixed inset-0 bg-black/35 z-40 md:hidden animate-fade-in"
            onClick={() => setCalendarOpen(false)}
          />
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white p-4 rounded-2xl shadow-xl w-72 select-none md:absolute md:top-12 md:left-auto md:right-0 md:translate-x-0 md:translate-y-0 md:border md:border-border-main">
            {showMonthYearSelector ? (
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 h-40">
                  ...
                  <div className="overflow-y-auto space-y-1 pr-1 border-r border-border-main scrollbar-thin">
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer ${isSelected
                ...
                {/* Bottom done action */}
                <div className="flex justify-end mt-4 pt-3 border-t border-border-main">
                  <button
                    onClick={() => setShowMonthYearSelector(false)}
              ...
              <>
                  ...
                  {Array.from({ length: new Date(currentCalendarDate.getFullYear(), currentCalendarDate.getMonth() + 1, 0).getDate() }).map((_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-8 h-8 flex items-center justify-center rounded-lg text-xs font-medium cursor-pointer transition ${isFuture
                ...
                {/* Bottom Reset & Close */}
                <div className="flex justify-between items-center mt-4 pt-3 border-t border-border-main">
                  <button
                    onClick={handleReset}
