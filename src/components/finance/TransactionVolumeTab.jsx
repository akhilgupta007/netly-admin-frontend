    ...
    <div className="animate-scale-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border border-secondary-bg rounded-3xl p-5 shadow-2xs space-y-2">
          <span className="text-[10px] text-text-muted block">Total bookings</span>
          <strong className="text-2xl text-text-primary font-bold block">365</strong>
          <span className="text-[9px] text-text-muted block">Jun 18-24</span>
        </div>

        <div className="bg-white border border-secondary-bg rounded-3xl p-5 shadow-2xs space-y-2">
          <span className="text-[10px] text-text-muted block">GMV (period)</span>
          <strong className="text-2xl text-text-primary font-bold block">$44,900.00</strong>
          <span className="text-[9px] text-text-muted block">Gross merchandise value</span>
        </div>

        <div className="bg-white border border-secondary-bg rounded-3xl p-5 shadow-2xs space-y-2">
          <span className="text-[10px] text-text-muted block">Average booking value</span>
          <strong className="text-2xl text-text-primary font-bold block">$126.12</strong>
          <span className="text-[9px] text-text-muted block">Per transaction</span>
        </div>
      </div>
      ...
      <div className="bg-white border border-secondary-bg rounded-3xl p-5 shadow-2xs space-y-4 mt-4">
        ...
        <div className="pt-4">
          <div className="flex items-stretch h-48 relative">
            ...
            <div className="w-8 flex flex-col justify-between text-[9px] text-text-muted pb-1 select-none">
              <span>80</span>
              <span>60</span>
              <span>40</span>
              <span>20</span>
            ...
            <div className="w-12 flex flex-col justify-between text-[9px] text-text-muted text-right pb-1 select-none">
              <span>$10.0k</span>
              <span>$7.5k</span>
              <span>$5.0k</span>
              <span>$2.5k</span>
          ...
          <div className="flex pl-8 pr-12 mt-2">
