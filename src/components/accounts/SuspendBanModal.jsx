...
export default function SuspendBanModal({ account, activeTab, isOpen, onClose, onSubmit }) {
      ...
      <div className="relative bg-white rounded-3xl w-full max-w-lg p-4 shadow-2xl z-10 border border-border-main animate-scale-up mx-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-page-bg rounded-2xl p-3 flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-semibold text-text-primary">{account.name}</h4>
              <p className="text-[10px] text-text-muted font-light">{account.email}</p>
            </div>
          </div>
