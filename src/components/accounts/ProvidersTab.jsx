              ...
              paginated.map((provider, idx) => (
                ...
                >
                  <td className="px-4 py-3 flex items-center gap-1.5">
                    <div className="w-7 h-7 rounded-md bg-primary-bg-muted text-white flex items-center justify-center md:text-[10px] text-[7px] font-light">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full md:text-xs text-[10px] ${getKycClass(provider.kyc)}`}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-wrap gap-1">
                      {provider.badges.map((b, idx) => (
                        <span key={idx} className="bg-primary-bg-muted/10 text-primary-bg md:text-xs text-[10px] font-medium px-2 py-0.5 rounded-md">
                          {b}
                        </span>
                      ))}
                    </div>
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-block px-2.5 py-0.5 rounded-full md:text-xs text-[10px] ${getStatusClass(provider.status)}`}>
                      {provider.status}
                    </span>
                  </td>
